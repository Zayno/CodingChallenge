...
public:
	...
	unsigned int RandomRange(unsigned int n1, unsigned int n2);
...
unsigned int CRandom::RandomRange( unsigned int n1, unsigned int n2 /*inclusive*/ )
{
	unsigned int iDiff = n2 - n1;

	int ret = Random(iDiff + 1);
	ret += n1;
	return ret;
}
